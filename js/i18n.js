...
const UI_STRINGS = {
  tr: {
    ...
    sync_title: "GITHUB'A OTOMATİK KAYIT",
    sync_body: "İlerlemenizi hiçbir düğmeye basmadan bu projenin GitHub deposuna otomatik kaydeder. GitHub anonim sayfaların yazmasına izin vermediği için yalnızca sizin elinizde olan bir kişisel erişim anahtarı (token) gerekir. Erişimi yalnızca {repo} deposuyla sınırlı, izni \"Issues: Read and write\" olan ince ayarlı (fine-grained) bir token oluşturup aşağıya yapıştırın. Token yalnızca bu tarayıcıda (localStorage) durur ve o depoda issue açıp düzenlemekten başka bir şey yapamaz. Depo sahibiyseniz ya da ortak çalışansanız işe yarar; değilseniz elle senkronizasyonu kullanın.",
    sync_get_token: "GitHub'da token oluştur →",
    sync_token_ph: "github_pat_…",
    sync_enable: "Otomatik kaydı aç",
    sync_manual: "Bunun yerine bir kez elle senkronize et",
    sync_disable: "Otomatik kaydı kapat",
    toast_synced: "GITHUB'A KAYDEDİLDİ",
    toast_sync_fail: "GitHub kaydı başarısız — yeniden denenecek",
    toast_sync_auth: "GitHub token'ı reddetti — Senkronize'yi açıp düzeltin",
    or_row: "veya",
  ...
  en: {
    ...
    sync_title: "AUTO-SAVE TO GITHUB",
    sync_body: "Saves your progress to this project's GitHub repo automatically, with no button presses. It needs a personal access token that only you hold, because GitHub doesn't let anonymous pages write. Create a fine-grained token with repository access limited to {repo} and the permission \"Issues: Read and write\", then paste it below. It stays in this browser only (localStorage) and can do nothing except create and edit issues on that one repository. It works if you own or collaborate on the repository; otherwise use the manual sync.",
    sync_get_token: "Create a token on GitHub →",
    sync_token_ph: "github_pat_…",
    sync_enable: "Enable auto-save",
    sync_manual: "Sync once manually instead",
    sync_disable: "Turn off auto-save",
    toast_synced: "SAVED TO GITHUB",
    toast_sync_fail: "GitHub save failed — will retry",
    toast_sync_auth: "GitHub rejected the token — open Sync to fix it",
    or_row: "or",
  ...
  es: {
    ...
    github_hint: "Escriba su nombre de usuario de GitHub para sincronizar su progreso y aparecer en la tabla de clasificación. Esto no es un inicio de sesión real protegido por contraseña — solo nos indica qué archivo de guardado buscar; la verificación real de identidad ocurre cuando pulsa \"Sincronizar con GitHub\" y lo envía desde su propia cuenta de GitHub.",
    lbl_github_username: "Nombre de usuario de GitHub",
    github_username_ph: "usuario",
    btn_continue: "Continuar",
    err_bad_username: "Nombre de usuario de GitHub no válido.",
    btn_sync: "Sincronizar con GitHub",
    sync_title: "GUARDADO AUTOMÁTICO EN GITHUB",
    sync_body: "Guarda su progreso en el repositorio de GitHub de este proyecto de forma automática, sin pulsar ningún botón. Necesita un token de acceso personal que solo usted posee, porque GitHub no permite que páginas anónimas escriban. Cree un token de granularidad fina con acceso limitado al repositorio {repo} y el permiso «Issues: Read and write», y péguelo a continuación. Permanece solo en este navegador (localStorage) y no puede hacer nada salvo crear y editar issues en ese repositorio. Funciona si usted es propietario o colaborador del repositorio; de lo contrario, use la sincronización manual.",
    sync_get_token: "Crear un token en GitHub →",
    sync_token_ph: "github_pat_…",
    sync_enable: "Activar guardado automático",
    sync_manual: "Sincronizar una vez manualmente",
    sync_disable: "Desactivar guardado automático",
    toast_synced: "GUARDADO EN GITHUB",
    toast_sync_fail: "Falló el guardado en GitHub — se reintentará",
    toast_sync_auth: "GitHub rechazó el token — abra Sincronizar para corregirlo",
    or_row: "o",
    btn_guest: "Jugar como invitado (sin cuenta)",
    nav_leaderboard: "clasificación",
    nav_logout: "salir",
    guest_mode: "Modo invitado (guardado solo en este navegador)",
    operator_label: "Auditor",
  ...
  fr: {
    ...
    github_hint: "Saisissez votre nom d'utilisateur GitHub pour synchroniser votre progression sur GitHub et apparaître dans le classement. Ce n'est pas une véritable connexion protégée par mot de passe — cela nous indique seulement quel fichier de sauvegarde rechercher ; la vérification d'identité réelle a lieu lorsque vous cliquez sur « Synchroniser avec GitHub » et que vous l'envoyez depuis votre propre compte GitHub.",
    lbl_github_username: "Nom d'utilisateur GitHub",
    github_username_ph: "nomdutilisateur",
    btn_continue: "Continuer",
    err_bad_username: "Nom d'utilisateur GitHub invalide.",
    btn_sync: "Synchroniser avec GitHub",
    sync_title: "SAUVEGARDE AUTOMATIQUE SUR GITHUB",
    sync_body: "Enregistre votre progression automatiquement dans le dépôt GitHub de ce projet, sans appuyer sur aucun bouton. Cela nécessite un jeton d'accès personnel que vous seul détenez, car GitHub n'autorise pas les pages anonymes à écrire. Créez un jeton à granularité fine dont l'accès est limité au dépôt {repo}, avec l'autorisation « Issues : Read and write », puis collez-le ci-dessous. Il reste uniquement dans ce navigateur (localStorage) et ne peut rien faire d'autre que créer et modifier des issues sur ce dépôt. Cela fonctionne si vous êtes propriétaire ou collaborateur du dépôt ; sinon, utilisez la synchronisation manuelle.",
    sync_get_token: "Créer un jeton sur GitHub →",
    sync_token_ph: "github_pat_…",
    sync_enable: "Activer la sauvegarde automatique",
    sync_manual: "Synchroniser une fois manuellement",
    sync_disable: "Désactiver la sauvegarde automatique",
    toast_synced: "ENREGISTRÉ SUR GITHUB",
    toast_sync_fail: "Échec de l'enregistrement GitHub — nouvelle tentative",
    toast_sync_auth: "GitHub a rejeté le jeton — ouvrez Synchroniser pour le corriger",
    or_row: "ou",
    btn_guest: "Jouer en tant qu'invité (sans compte)",
    nav_leaderboard: "classement",
    nav_logout: "déconnexion",
    guest_mode: "Mode invité (enregistré uniquement dans ce navigateur)",
    operator_label: "Auditeur",
